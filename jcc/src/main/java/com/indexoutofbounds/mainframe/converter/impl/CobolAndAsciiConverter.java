...
public class CobolAndAsciiConverter implements ICobolAndJavaConverter {
	 ...
	 * encoding setting.
	 * 
     * @param toCharset - the to charset we are using for conversion
     * @param fromCharset - the from charset we are using for conversion
	 * for more information on the default Charsets. 
	 */
	public CobolAndAsciiConverter(Charset toCharset, Charset fromCharset) {

        this.toCharset = fromCharset;
	 ...
	 * for more information on the default Charsets.
	 */
	public CobolAndAsciiConverter(Charset toCharset, Charset fromCharset, String encoding) {
	 ...
	 */
	public String convertAlphaNumericDisplay(byte[] ddata) throws MainFrameConversionException {
	...
	public String convertNumericValue(byte[] number, int scale) throws MainFrameConversionException {
		...
		double d = NumericConversionUtils.convertNumericToDouble(number, scale);
	...
	public String convertNumericValueWithHighPrecision(byte[] number, int scale) throws MainFrameConversionException {
		...
		sb.append(NumericConversionUtils.convertNumericToString(number, scale));
	...
	public String convertCOMP3(byte[] buffer, int scale) throws MainFrameConversionException {
		...
		double d = Comp3ConversionUtils.convertCOMP3ToDouble(buffer, scale);
	...
	public String convertCOMP3WithHighPrecision(byte[] number, int scale) throws MainFrameConversionException {
		...
		sb.append(Comp3ConversionUtils.convertCOMP3ToString(number, scale));
	...
	public byte[] convertString(String value, int byteLength) throws MainFrameConversionException {
		...
		if (value.getBytes().length > byteLength) {
            // can't store data.
        ...
        for (int i = value.getBytes().length; i < byteLength; i++) {
            paddedvalue.append(" ");
        }
        
		byte[] ebcdic = new byte[byteLength];

		byte[] ascii = paddedvalue.toString().getBytes();
	...
	public byte[] packIntIntoCOMP3(int value, int byteLength, int scale, boolean isSigned) throws MainFrameConversionException {
		...
		byte[] bytes = Comp3ConversionUtils.convertIntToCOMP3(value, byteLength, scale, isSigned);
	...
	public byte[] packDoubleIntoCOMP3(double value, int byteLength, int scale, boolean isSigned) throws MainFrameConversionException {
		...
		byte[] bytes = Comp3ConversionUtils.convertDoubleToCOMP3(value, byteLength, scale, isSigned);
	 ...
	 * @throws MainFrameConversionException if something went bad
	 */
	public byte[] numericFromInt(int value, int byteLength, int scale, boolean isSigned) throws MainFrameConversionException {

		byte[] bytes = NumericConversionUtils.convertIntToNumeric(value, byteLength, scale, isSigned);
	...
	public byte[] numericFromDouble(double value, int byteLength, int scale, boolean isSigned) throws MainFrameConversionException {
		...
		byte[] bytes = NumericConversionUtils.convertDoubleToNumeric(value, byteLength, scale, isSigned);
	 ...
	 * @throws MainFrameConversionException if something went wrong
	 */
	protected char convert(int value) throws MainFrameConversionException {
		return convert(value, this.getToCharset(), this.getFromCharset());
	}
	 ...
	 * 
	 * @param value the int to convert
	 * @param toCharset - the Converter to use
     * @param fromCharset - the Converter to use
	 * @throws MainFrameConversionException if something went wrong
	 */
	protected char convert(int value, Charset toCharset, Charset fromCharset) throws MainFrameConversionException {
		return convert(value, toCharset.getCharset(), fromCharset.getCharset());
	}
	 ...
	 * @throws MainFrameConversionException if something went wrong
	 */
	protected char convert(int value, int[] toCharset, int[] fromCharset) throws MainFrameConversionException {
		...
		throw new MainFrameConversionException(MainFrameGlobals.CharsetConverter_CONVERT_BAD_TRANSLATION + " " + value);
	}
	...
	public void configureAsciiToEBCDIC() {
        this.toCharset = new EBCDICCharset();
        this.fromCharset = new ASCIICharset();
	}
	...
	public void configureEBCDICToAscii() {
        this.toCharset = new ASCIICharset();
        this.fromCharset = new EBCDICCharset();
	}
	 ...
	 */
	private static char[] byteArrayToCharArray(byte[] b, String encoding) throws MainFrameConversionException {
		...
		try {
			...
			throw new MainFrameConversionException(MainFrameGlobals.CharsetConverter_ByteArrayToCharArray);
		}
	}
