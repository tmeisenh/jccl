...
/**
 * Algorithms for Numeric data conversion.
 * 
 * @author <a href="mailto:travis@indexoutofbounds.com">Travis Meisenheimer</a>
 * @version $Id$
 */
public class NumericConversionUtils extends BaseCobolUtils {

	/**
	 * Logger this class uses.
	 */
	private static Logger log = Logger.getLogger(NumericConversionUtils.class);	

	public NumericConversionUtils() {
	}
	 ...
	 */
	public static final String convertNumericToString(byte[] buffer, int scale) throws MainFrameConversionException {
	 ...
	 * @throws MainFrameConversionException if the specified representation is not recognized.
	 */
	public static final double convertNumericToDouble(byte[] buffer, int scale) throws MainFrameConversionException {
	 ...
	 * @throws MainFrameConversionException if the specified representation is not recognized.
	 */
	public static final long convertNumericToLong(byte[] buffer, int scale) throws MainFrameConversionException {
	...
	/**
	  ...
	  */
	public static byte[] convertIntToNumeric(int val, int byteLength, int scale, boolean isSigned) throws MainFrameConversionException {
	 ...
	 * @throws MainFrameConversionException
	 */
	public static byte[] convertDoubleToNumeric(double val, int byteLength, int scale, boolean isSigned) throws MainFrameConversionException {
        ...
        //log.debug("Formatted double: " + formatDoubleValue(val));
	 ...
	 * @throws MainFrameConversionException
	 */
	private static int unpackNumericByte(byte b) throws MainFrameConversionException {
	 ...
	 * @throws MainFrameConversionException
	 */
	private static final String numericNybblesToString(byte[] buffer) throws MainFrameConversionException {
	 ...
	 * @throws MainFrameConversionException
	 */
	private static final int numericNybblesToInt(byte[] buffer) throws MainFrameConversionException {
	 ...
	 * @throws MainFrameConversionException
	 */
	private static final long numericNybblesToLong(byte[] buffer) throws MainFrameConversionException {
	 ...
	 * @throws MainFrameConversionException
	 */
	private static final double numericNybblesToDouble(byte[] buffer) throws MainFrameConversionException  {
	 ...
	 * @throws MainFrameConversionException
	 */
	private static String normalizeJavaDataIntoNumericByteString(String value, int byteLength, int scale, char sign) throws MainFrameConversionException {
		StringBuffer sb = new StringBuffer();
		int precedingZeros = 0;
		log.debug("sign: " + sign + ", " + SIGN_POS + ", " + SIGN_NEG + ", " + SIGN_UNSIGNED + ", " + HEX_NEG);
		...
		if (log.isEnabledFor(Level.DEBUG)) {
			log.debug(
				"NumericConversionUtils.normalizeJavaDataIntoNumericByteString("
					+ value + ", " + byteLength + ", " + scale 	+ ", " 
                    + sign 	+ ") output: " 	+ displayInBytePattern(sb.toString()));
		}
        
		log.debug("NORMALIZED: [" + sb.toString()+ "]");
		return sb.toString();
	}
