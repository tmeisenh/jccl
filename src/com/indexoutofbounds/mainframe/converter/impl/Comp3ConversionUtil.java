...
public class Comp3ConversionUtil extends BaseCobolUtils {


	/**
	 * Logger this class uses.
	 */
	private static Logger log = Logger.getLogger(Comp3ConversionUtil.class);

	public Comp3ConversionUtil() {
...
//			TODO check this
	...
	private static String normalizeJavaDataIntoCOMP3ByteString(String value, int byteLength, int scale, char sign) throws Sock7Exception {
		...
		if (log.isEnabledFor(Level.DEBUG)) {
			log.debug(
				"COBOLConversionUtil.normalizeJavaDataIntoCOMP3ByteString("
					+ value
					+ ", "
					+ byteLength
					+ ", "
