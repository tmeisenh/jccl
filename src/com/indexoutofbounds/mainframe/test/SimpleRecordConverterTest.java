...
public class SimpleRecordConverterTest {
	...
	public static void main(String[] args) {
		...
		FlatFileLayout file = new FlatFileLayout("/Volumes/User/travis/Documents/code/comp3library/sf-ebcdic/cobol_files/rural_route_binary_big.txt", recordlayout);
		
		try {
			IRecordConverter src = new SimpleRecordConverter("/Volumes/User/travis/Documents/code/comp3library/sf-ebcdic/cobol_files/rural_route_binary_big.txt", recordlayout);
				
			Record filerecord;
			
			while ( (filerecord = src.getNextRecord()) != null) {
				//System.out.println(filerecord.toString());
				//System.out.println(filerecord.getFieldByName("ROUTE_LENGTH_MILES"));
				System.out.println("Converted " + filerecord.getRecordNumber());
				System.exit(0);
			}
